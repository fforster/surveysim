...
leftraru = False
if os.getcwd() == "/home/alexbaper/surveysim":
    leftraru = True
...
if leftraru:
    os.environ["SURVEYSIM_PATH"] = "/home/alexbaper/surveysim"
    os.environ["SURVEYSIM_PATH_INPUT"] = "/home/fforster/surveysim"
    os.environ["SURVEYSIM_PATH_OUTPUT"] = "/home/alexbaper/surveysim"
else:
...
if __name__ == "__main__":
    ...
    plt.savefig("plots/Bestfit_%s_%s_%s.png" % (LCs.modelname, LCs.objname, fixedvars[7]))
